...
public class ReadExcelData {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
	 FileInputStream fis = new FileInputStream("./Data/TestData.xlsx");  // provide path
	 Workbook wb = WorkbookFactory.create(fis); // make the file to ready for read opration
